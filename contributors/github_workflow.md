...
This guide assumes you have already cloned the upstream repo to your system via `git clone`, or via `go get github.com/k0sproject/k0smotron`.

## Fork The Project

1. Go to http://github.com/k0sproject/k0smotron
