...
func InitManagementClusterAndWatchControllerLogs(ctx context.Context, input clusterctl.InitManagementClusterAndWatchControllerLogsInput, intervals ...interface{}) error {
