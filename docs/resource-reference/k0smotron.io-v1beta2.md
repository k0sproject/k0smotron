...
will use emptyDir as a volume. See https://docs.k0smotron.io/stable/configuration/#persistence<br/>
        ...
        <td><b><a href="#clusterspecremotehostcluster">remoteHostCluster</a></b></td>
        <td>object</td>
        <td>
...
### Cluster.spec.remoteHostCluster
<sup><sup>[↩ Parent](#clusterspec)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#clusterspecremotehostclusterkubeconfigref">kubeconfigRef</a></b></td>
        <td>object</td>
        <td>
...
### Cluster.spec.remoteHostCluster.kubeconfigRef
<sup><sup>[↩ Parent](#clusterspecremotehostcluster)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>string</td>
        <td>
          clusterName is the name of the k0smotron Cluster this object belongs to.<br/>
        </td>
        <td>true</td>
      </tr><tr>
        <td><b>expiry</b></td>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#jointokenrequeststatusconditionsindex">conditions</a></b></td>
        <td>[]object</td>
        <td>
          Conditions represents the observations of the k0smotron cluster's state.
Known condition types are Available, Deleting.<br/>
        ...
        <td><b><a href="#jointokenrequeststatusdeprecated">deprecated</a></b></td>
        <td>object</td>
        <td>
          deprecated groups all the status fields that are deprecated and will be removed when all the nested field are removed.<br/>
        </td>
...
### JoinTokenRequest.status.conditions[index]
<sup><sup>[↩ Parent](#jointokenrequeststatus)</sup></sup>
...
### JoinTokenRequest.status.deprecated
<sup><sup>[↩ Parent](#jointokenrequeststatus)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#jointokenrequeststatusdeprecatedv1beta1">v1beta1</a></b></td>
        <td>object</td>
        <td>
          v1beta1 groups all the status fields that are deprecated and will be removed when support for v1beta1 will be dropped.<br/>
        </td>
...
### JoinTokenRequest.status.deprecated.v1beta1
<sup><sup>[↩ Parent](#jointokenrequeststatusdeprecated)</sup></sup>
