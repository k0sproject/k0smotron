...
generate-aws-e2e-templates: $(KUSTOMIZE)
	...
	$(KUSTOMIZE) build $(AWS_TEMPLATES)/cluster-template-windows-ingress-host --load-restrictor LoadRestrictionsNone > $(AWS_TEMPLATES)/cluster-template-windows-ingress-host.yaml
