module github.com/k0sproject/k0smotron/v2
...
require (
	...
	github.com/k0sproject/k0s v1.35.6-0.20260609151144-b9b98c4feb9d
...
replace github.com/k0sproject/k0s => github.com/apedriza/k0s v1.35.6-0.20260626101827-2f96fc79890e
