...
require (
	...
	github.com/k0sproject/k0s v1.30.5-0.20240821154333-ee185e719fb2
...
// Cluster API deps
require sigs.k8s.io/cluster-api v1.8.1

// Replacements duplicated from upstream Kubernetes
replace (
	github.com/k0sproject/k0s => github.com/juanluisvaladas/k0s v1.26.1-0.20240902090730-2ffeb8f3d081
