...
import (
	...
	infrastructurev1beta1 "github.com/k0sproject/k0smotron/v2/api/infrastructure/v1beta1"
	...
	"github.com/k0sproject/k0smotron/v2/internal/controller/bootstrap"
	"github.com/k0sproject/k0smotron/v2/internal/controller/controlplane"
	"github.com/k0sproject/k0smotron/v2/internal/controller/infrastructure"
	controller "github.com/k0sproject/k0smotron/v2/internal/controller/k0smotron.io"
...
func main() {
	...
	cacheOptions, err := newCacheOptions(namespace, watchFilter)
	if err != nil {
		setupLog.Error(err, "unable to parse watch flags")
		os.Exit(1)
	}
...
func newCacheOptions(namespace, watchFilter string) (cache.Options, error) {
	...
	if watchFilter != "" {
		filterReq, err := labels.NewRequirement(clusterv1.WatchLabel, selection.Equals, []string{watchFilter})
		if err != nil {
			return cache.Options{}, err
		}
		watchSelector = labels.NewSelector().Add(*filterReq)
	}
