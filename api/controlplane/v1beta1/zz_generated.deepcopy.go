...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *K0smotronControlPlaneMachineTemplate) DeepCopyInto(out *K0smotronControlPlaneMachineTemplate) {
	*out = *in
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.InfrastructureRef = in.InfrastructureRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new K0smotronControlPlaneMachineTemplate.
func (in *K0smotronControlPlaneMachineTemplate) DeepCopy() *K0smotronControlPlaneMachineTemplate {
	if in == nil {
		return nil
	}
	out := new(K0smotronControlPlaneMachineTemplate)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *K0smotronControlPlaneSpec) DeepCopyInto(out *K0smotronControlPlaneSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new K0smotronControlPlaneSpec.
func (in *K0smotronControlPlaneSpec) DeepCopy() *K0smotronControlPlaneSpec {
	if in == nil {
		return nil
	}
	out := new(K0smotronControlPlaneSpec)
	in.DeepCopyInto(out)
	return out
}
