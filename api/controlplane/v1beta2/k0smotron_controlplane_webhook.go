...
func (v *K0smotronControlPlaneValidator) ValidateUpdate(_ context.Context, oldKcp, newKcp *K0smotronControlPlane) (admission.Warnings, error) {
	if oldKcp == nil {
		return nil, fmt.Errorf("expected an old K0smotronControlPlane object but got nil")
	}
	if newKcp == nil {
		return nil, fmt.Errorf("expected a new K0smotronControlPlane object but got nil")
	}
