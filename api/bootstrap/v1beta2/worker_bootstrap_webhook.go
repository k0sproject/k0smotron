...
// ValidateCreate implements admission.Validator for K0sWorkerConfig.
...
// ValidateUpdate implements admission.Validator for K0sWorkerConfig.
func (v *K0sWorkerConfigValidator) ValidateUpdate(_ context.Context, _, newC *K0sWorkerConfig) (admission.Warnings, error) {
	return nil, v.validate(newC.Spec, newC.Name)
}

// ValidateDelete implements admission.Validator for K0sWorkerConfig.
