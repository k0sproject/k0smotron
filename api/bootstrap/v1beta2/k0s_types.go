...
// Platform defines the target platform for the worker node.
...
// ProvisionerWarnings reports the fields the chosen provisioner will ignore, since a
// config carried over from another provisioner is likelier than a deliberate one.
func ProvisionerWarnings(spec ProvisionerSpec, pathPrefix *field.Path) admission.Warnings {
