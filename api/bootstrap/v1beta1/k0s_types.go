...
type K0sWorkerConfigSpec struct {
	...
	// +kubebuilder:validation:Optional
	CustomUserDataRef *v1beta2.ContentSource `json:"customUserDataRef,omitempty"`

	// SecretMetadata specifies metadata (labels and annotations) to be propagated to the bootstrap Secret.
	// +kubebuilder:validation:Optional
	SecretMetadata *v1beta2.SecretMetadata `json:"secretMetadata,omitempty"`
...
type K0sConfigSpec struct {
	...
	//+kubebuilder:validation:Optional
	Tunneling v1beta2.TunnelingSpec `json:"tunneling,omitempty"`
