...
type ClusterSpec struct {
	...
	// KineDataSourceURL or KineDataSourceSecretRef are required for HA controlplane setup
	// and one of them must be set if replicas > 1.
	//+kubebuilder:validation:Optional
	KineDataSourceURL string `json:"kineDataSourceURL,omitempty"`
	// KineDataSourceSecretRef defines the kine datasource URL secret.
	// KineDataSourceURL or KineDataSourceSecretRef are required for HA controlplane setup
	// and one of them must be set if replicas > 1.
	//+kubebuilder:validation:Optional
	KineDataSourceSecretRef *ResourceRef `json:"kineDataSourceSecretRef,omitempty"`
