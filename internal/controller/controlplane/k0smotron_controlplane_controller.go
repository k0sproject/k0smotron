...
// +kubebuilder:rbac:groups=controlplane.cluster.x-k8s.io,resources=k0smotroncontrolplanes/finalizers,verbs=update
...
func (c *K0smotronController) Reconcile(ctx context.Context, req ctrl.Request) (res ctrl.Result, err error) {
	...
	if finalizerAdded, err := finalizers.EnsureFinalizer(ctx, c.Client, kcp, cpv1beta2.K0smotronControlPlaneFinalizer); err != nil || finalizerAdded {
		return ctrl.Result{}, err
	}
