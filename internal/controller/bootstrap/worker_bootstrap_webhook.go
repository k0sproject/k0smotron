...
// +kubebuilder:webhook:path=/mutate-bootstrap-cluster-x-k8s-io-v1beta1-k0sworkerconfig,mutating=true,failurePolicy=fail,sideEffects=None,groups=bootstrap.cluster.x-k8s.io,resources=k0sworkerconfigs,verbs=create;update,versions=v1beta1,name=mutate-k0sworkerconfig-v1beta1.k0smotron.io,admissionReviewVersions=v1
