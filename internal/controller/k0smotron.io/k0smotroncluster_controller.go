...
import (
	...
	kutil "github.com/k0smotron/k0smotron/internal/controller/util"
)
...
func (scope *kmcScope) ensureCertificates(ctx context.Context, kmc *km.Cluster) error {
	...
	err := certificates.LookupOrGenerate(ctx, scope.client, util.ObjectKey(kmc), *metav1.NewControllerRef(kmc, km.GroupVersion.WithKind("Cluster")))
	if err != nil {
...
func (r *ClusterReconciler) getKmcScope(ctx context.Context, kmc *km.Cluster) (*kmcScope, error) {
	...
	if kmc.Spec.ClusterProfileRef != nil {
