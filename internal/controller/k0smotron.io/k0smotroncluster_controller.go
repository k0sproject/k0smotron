...
const serviceAccountName = "k0smotron"
...
func (r *ClusterReconciler) ensureServiceAccountRoleAndBinding(ctx context.Context, kmc *km.Cluster) error {
	...
	if err := r.Get(ctx, client.ObjectKey{Name: serviceAccountName, Namespace: kmc.Namespace}, sa); client.IgnoreNotFound(err) != nil {
		return err
	} else if err != nil {
	...
	if err := r.Get(ctx, client.ObjectKey{Name: serviceAccountName, Namespace: kmc.Namespace}, role); client.IgnoreNotFound(err) != nil {
		return err
	} else if err != nil {
	...
	if err := r.Get(ctx, client.ObjectKey{Name: serviceAccountName, Namespace: kmc.Namespace}, roleBinding); client.IgnoreNotFound(err) != nil {
		return err
	} else if err != nil {
