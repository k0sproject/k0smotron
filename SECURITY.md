...
This policy is adapted from the [policy of k0s](https://github.com/k0sproject/k0s/blob/main/SECURITY.md).

## Reporting a vulnerability

k0smotron supports responsible disclosure and endeavors to resolve security issues in a reasonable timeframe.
...
2. Send an email to cncf-k0s-maintainers@lists.cncf.io detailing the issue, see below for some examples of info that might be useful including.
    ...
    The reporter(s) can typically expect a response within 48 hours acknowledging the issue was received. If a response is not received within 48 hours, please reach out to any of the [maintainers] directly to confirm receipt of the issue.
...
[Security tab]: https://github.com/k0sproject/k0smotron/security
[maintainers]: https://github.com/k0sproject/k0s/blob/main/MAINTAINERS.md
...
* Versions of k0smotron used and more broadly of any other software involved.
* Configuration used (in-cluster resources, command line flags, etc).
...
* Owners of the @k0sproject organization, including CNCF staff
* Committers
* Security Advisors
* Reporter(s)
