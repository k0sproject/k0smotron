...
type CAPIDockerMachineTemplateUpdateRecreateDeleteFirst struct {
	//type CAPIDockerMachineTemplateUpdateRecreateDeleteFirst struct {
	suite.Suite
...
func TestCAPIDockerMachineTemplateUpdateRecreate(t *testing.T) {
	s := CAPIDockerMachineTemplateUpdateRecreateDeleteFirst{}
	suite.Run(t, &s)
}

func (s *CAPIDockerMachineTemplateUpdateRecreateDeleteFirst) SetupSuite() {
...
func (s *CAPIDockerMachineTemplateUpdateRecreateDeleteFirst) TestCAPIControlPlaneDockerDownScaling() {
...
func (s *CAPIDockerMachineTemplateUpdateRecreateDeleteFirst) applyClusterObjects() {
	// Exec via kubectl
...
func (s *CAPIDockerMachineTemplateUpdateRecreateDeleteFirst) updateClusterObjects() {
	// Exec via kubectl
