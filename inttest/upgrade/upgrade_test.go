...
func (s *UpgradeSuite) TestK0smotronUpgrade() {
	...
	s.addStateInMountedPath(s.Context(), pod.Spec.Containers[0].VolumeMounts[1].MountPath, kc, rc)
...
func (s *UpgradeSuite) addStateInMountedPath(ctx context.Context, mountedPath string, kc *kubernetes.Clientset, rc *rest.Config) {
